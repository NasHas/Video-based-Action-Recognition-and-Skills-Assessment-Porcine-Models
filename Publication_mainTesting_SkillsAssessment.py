...
modelName = 'NAME OF BEST MODEL.h5'
...
cm.plot()
pyplot.savefig("Confusion_matrix_SA.png")
pyplot.close()
...
with open("Classification_Report_SA.txt", "w") as file:
    file.write(report)
...
ax.set_xlabel('Experienced vs Novice [Sequence]')
...
plt.savefig("DvSProbDist_SA.png")
# show the plot
plt.show()
plt.close()
